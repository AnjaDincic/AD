...
<body>
  ...
  <section id="about">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Izmena članka</h3>
    ...
    <form method="post" action="">
      ...
      <div class="form-group">
            ...
            <div class="form-group ">
              <button type="submit" name="unesi" id="button" class="btn btn-primary btn-lg btn-block">Izmeni članak</button>
            </div>
