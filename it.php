  ...
  <script>
            ...
            $('#tabela').html("");
      			...
      			$.ajax({
      				...
      				var text = '<table class="table table-hover text-center"><thead><tr><th> </th><th >Članak</th><th width="150px" >Datum</th><th>Autor</th></tr></thead><tbody>';
      				$.each($.parseJSON(result), function(i, val) {

                					
      					text += '<tr>';
                text += '<td><img src="img/'+val.slika+'" width="250px" height="200px"/></td>';
      					text += '<td><span id="naslov">'+val.naslov+'</span><span id="more">'+val.tekst+'</span><br><button onclick="myfunction()" id= "myBtn">Procitaj</button></td>';
      ...
      <script >
        function myfunction() {
            ...
            if(naslov.style.display === "none"){
              naslov.style.display = "inline";
